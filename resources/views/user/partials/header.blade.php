        ...
        <div class="row">
            <div class="col-md-6 col-sm-4">
                <div class="left-header clearfix">
                    <ul>
                        <li><p><i class="fa fa-phone" aria-hidden="true"></i>0334938322</p></li>
                        <li class="hd-none"><p><i class="fa fa-clock-o" aria-hidden="true"></i>Mon-fri : 8:00-21:00</p></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="container relative">
        <div class="row">
            <div class="col-sm-2 col-md-2 col-xs-4">
                <div class="logo">
                    <a href="index.html"><img src="{{asset('tasnm/img/logo.png')}}" alt="" /></a>
                </div>
            </div>
